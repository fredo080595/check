                    ...
                    <br>
                      <div id="contenedor_car">
                         ...
                         ?>
                              ...
                              <button onclick="window.location='comprar.php'" class="btn btn-success">Finalizar compra</button>
                  </div>
                              <button onclick="window.location='index.php'" class="btn btn-success">Seguir comprando</button>
              </div>
       </div>
